...
$hasContractors = count($contractors) > 0;
$generatedHtml = null;
$errorMessage = null;
    ...
    <main class="dashboard-shell">
        <section class="dashboard-card">
            ...
            <div class="panel">
                ...
                <?php endif; ?>
                <?php if (!$hasTemplates || !$hasContractors): ?>
                    <div class="status error">
                        <?php if (!$hasTemplates && !$hasContractors): ?>Please ask an administrator to add templates and contractors before generating documents.
                        <?php elseif (!$hasTemplates): ?>Please ask an administrator to add templates before generating documents.
                        <?php else: ?>Please ask an administrator to add contractor records before generating documents.
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                <form method="post" class="inline-form" autocomplete="off">
                    <div class="form-group">
                        ...
                        <select id="template_id" name="template_id" required <?php echo !$hasTemplates ? 'disabled' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select id="contractor_id" name="contractor_id" required <?php echo !$hasContractors ? 'disabled' : ''; ?>>
                    ...
                    <button type="submit" <?php echo (!$hasTemplates || !$hasContractors) ? 'disabled class="btn-secondary"' : ''; ?>>Generate</button>
                </form>
            </div>
